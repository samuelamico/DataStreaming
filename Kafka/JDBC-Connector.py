...
def configure_connector():
    ...
    # Use:
    # VIew All connectors ON: curl http:<connect_url>/connectors/
    # View th curretn status: curl http:<connect_url>/connectors/<your_connector>/status
    # View the task ID: curl http:<connect_url>/connectors/<your_connector>/tasks/<task_id>/status
